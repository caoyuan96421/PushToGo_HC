...
void MountScreenViewBase::setupScreen()
{
...
void MountScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    else if (&src == &align_button)
    {
        ...
        //Go to AlignScreen with screen transition towards East
