...
void HomeScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    else if (&src == &starmap_view)
    {
        ...
        //Go to StarMapScreen with screen transition towards North
        application().gotoStarMapScreenScreenCoverTransitionNorth();
    }
    ...
    else if (&src == &utility_view)
    {
        ...
        //Go to UtilityScreen with screen transition towards East
