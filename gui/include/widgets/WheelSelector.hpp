...
public:
    ...
    void setElementSelectedCallback(touchgfx::GenericCallback<const WheelSelector&, const int&>& callback) { elementSelectedAction = &callback; }
...
protected:
    ...
    touchgfx::Callback<WheelSelector, const MoveAnimator<TextArea>& > textMoveEndedCallback;
    void textMoveEndedHandler(const MoveAnimator<TextArea>& text);
